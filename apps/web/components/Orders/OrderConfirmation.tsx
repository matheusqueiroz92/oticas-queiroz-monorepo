    ...
    <div className="grid grid-cols-12 gap-6 h-full">
      <div className="col-span-9 space-y-4">
        ...
        <div className="bg-gray-50 p-4 rounded border">
          <h4 className="font-medium text-sm mb-3 text-gray-700">Resumo das Informações</h4>
          
          <div className="grid grid-cols-2 gap-6">
            <div className="space-y-3">
              <div>
                <h5 className="font-medium text-xs text-gray-600 uppercase tracking-wide">Cliente</h5>
              ...
              <div>
                <h5 className="font-medium text-xs text-gray-600 uppercase tracking-wide">Pagamento</h5>
            ...
            <div className="space-y-3">
              <div>
                <h5 className="font-medium text-xs text-gray-600 uppercase tracking-wide">Datas</h5>
              ...
              {form.getValues("isInstitutionalOrder") && (
                <div>
                  <h5 className="font-medium text-xs text-gray-600 uppercase tracking-wide">Pedido Institucional</h5>
          ...
          <div className="mt-4 pt-3 border-t">
            <h5 className="font-medium text-xs text-gray-600 uppercase tracking-wide mb-2">Produtos</h5>
          ...
          {form && form.getValues("observations") && (
            <div className="mt-3 pt-3 border-t">
              <h5 className="font-medium text-xs text-gray-600 uppercase tracking-wide">Observações</h5>
